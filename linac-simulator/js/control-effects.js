export const CONTROL_EFFECTS=Object.freeze({
  ...
  energy:{part:'waveguide',plane:'energy',start:'waveguide',label:'Electron momentum',text:'Verandert de relatieve elektronenrigiditeit. Daardoor veranderen steeringgevoeligheid en bendingrespons, maar de bundel wordt niet vóór de relevante magneten kunstmatig verschoven.'},
  ...
  gantry:{part:'steer2',plane:'feedback',start:'gun',label:'Gantry angle',text:'Verandert de genormaliseerde gantry-afhankelijke beam disturbance en, indien actief, LUT/servo-correctie. Dit is een globale omgevings-/feedbackrespons, geen lokale magneetverplaatsing.'}
});
