const CACHE='linac-dashboard-v29-linac-simulator';
const CORE=[
  './','./index.html?v=19','./dashboard.css?v=4','./manifest.webmanifest?v=13','./umc-utrecht-banner.svg?v=1',
  ...
  './linac-simulator/index.html?v=1','./linac-simulator/simulator.css?v=1','./linac-simulator/js/config.js','./linac-simulator/js/beam-model.js','./linac-simulator/js/render.js','./linac-simulator/js/main.js'
];
