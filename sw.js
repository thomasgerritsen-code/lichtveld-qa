const CACHE='linac-dashboard-v32-beam-render-fix';
const CORE=[
  ...
  './linac-simulator/index.html?v=4','./linac-simulator/simulator.css?v=3','./linac-simulator/js/config.js','./linac-simulator/js/beam-model.js','./linac-simulator/js/render.js','./linac-simulator/js/training.js?v=4','./linac-simulator/js/metrics.js','./linac-simulator/js/main.js?v=4'
];
