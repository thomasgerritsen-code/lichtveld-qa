const CACHE='linac-dashboard-v35-target-selector-v7';
const CORE=[
  './','./index.html?v=23','./dashboard.css?v=4','./manifest.webmanifest?v=13','./umc-utrecht-banner.svg?v=1',
  ...
  './manuals.html?v=1','./all-diagrams.html?v=5',
  './linac-simulator/index.html?v=7','./linac-simulator/simulator.css?v=7','./linac-simulator/js/config.js?v=7','./linac-simulator/js/beam-model.js?v=7','./linac-simulator/js/render.js?v=7','./linac-simulator/js/training.js?v=5','./linac-simulator/js/metrics.js?v=5','./linac-simulator/js/feedback.js?v=5','./linac-simulator/js/detector.js?v=5','./linac-simulator/js/diagnostics.js?v=7','./linac-simulator/js/sources.js?v=7','./linac-simulator/js/main.js?v=7'
];
